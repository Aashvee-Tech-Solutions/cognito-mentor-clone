          ...
          <ScrollReveal>
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button className="btn-shiny group" onClick={() => window.open(LEARNING_URL, "_blank")}>
                  Get Started
                  <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </Button>
                <Button variant="ghost" className="btn-outline" onClick={() => window.open(LEARNING_URL, "_blank")}>
                  Learn More
                </Button>
              </div>
            </div>
                ...
                <div className="bg-gradient-to-br from-card to-background border border-border rounded-3xl p-8 shadow-2xl">
                  <div className="grid grid-cols-2 gap-6">
                    {[
                      ...
                      <div key={stat.label} className="bg-secondary/50 rounded-2xl p-6 text-center hover:bg-secondary/70 transition-colors">
